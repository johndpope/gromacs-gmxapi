...
#    docker build -t gmxapi/acceptance:${REF} --build-arg REF=${REF} -f acceptance.dockerfile ..
...
CMD ["/home/testing/scripts/super_test.sh"]
# Alternatively, /home/testing/scripts/required_functionality.sh

# MPI tests can be run in this container without requiring MPI on the host.
#     docker run --rm -t gmxapi/acceptance:${REF} /home/testing/scripts/run_pytest_mpi.sh
